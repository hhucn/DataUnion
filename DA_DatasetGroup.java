...
public class DA_DatasetGroup {
    ...
    /**
     * remove all datasets with type "Start" and "Ende" if Gruppe has datasets
     * with the Real or BackD.
     */
    ...
    public void setMin() {
        if (Datasets.size() != 0) {
            ...
            for (int i = 0; i < Datasets.size(); i++) {
                ...
                if (od.datarate < min_datarate && od.datarate != -1) {
                    min_datarate = od.datarate;
                }
                if (od.delay < min_delay && od.delay != -1) {
                    min_delay = od.delay;
                }
                if (od.loss_rate < min_loss_rate && od.loss_rate != -1) {
                    min_loss_rate = od.loss_rate;
                }
            }

            if (min_datarate == Integer.MAX_VALUE) {
                min_datarate = DEFAULT_VALUE;
            }
            if (min_delay == Double.MAX_VALUE) {
                min_delay = DEFAULT_VALUE;
            }
            if (min_loss_rate == Double.MAX_VALUE) {
                min_loss_rate = DEFAULT_VALUE;
            }
        }
    }
    ...
    public void setMax() {
        if (Datasets.size() != 0) {
            ...
            if (max_datarate == Integer.MIN_VALUE) {
                max_datarate = DEFAULT_VALUE;
            }
            if (max_delay == -Double.MAX_VALUE) {
                max_delay = DEFAULT_VALUE;
            }
            if (max_loss_rate == -Double.MAX_VALUE) {
                max_loss_rate = DEFAULT_VALUE;
            }
        }
    }
    ...
    public void setMed() {
        ...
        if (Datasets.size() != 0) {
            ...
            for (int i = 0; i < Datasets.size(); i++) {
                ...
                if (od.datarate != -1) {
                    ts_datarate.add(new Double(od.datarate));
                }
                if (od.delay != -1) {
                    ts_delay.add(new Double(od.delay));
                }
                if (od.loss_rate != -1) {
                    ts_loss_rate.add(new Double(od.loss_rate));
                }
            }
